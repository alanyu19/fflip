...
sm_gs.append(
    CharmmGroup(
        ...
        add_charge_nbgroup=[True, True, True, True, True, True, True, True],
        ...
        cooperators=None,
        add_lj_nbgroup=[False, False, False, False, False, False, False, False],
...
sm = Lipid(charmm_group_list=sm_gs, name="SM")
