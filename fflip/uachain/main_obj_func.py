...
class head_obj_func(object):
    def __init__(self, targets, driver_path, prm_names, lb, ub, usesoftconstraint = True, broken_point = 0, **kwargs):
    ...
    def __call__(self, x, grad):
        from fflip.tailnew.objective_funcs import objective_function, objective_function_continue
