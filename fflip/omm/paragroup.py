...
class gtcnp(object):
    ...
    "gtcnp" = GroupToChangeNonbondedParameterss
    """
    ...
    def __repr__(self):
        ...
        if self.par_type == "charge":
            return "gtcnp(par_type = '{}', center_names = {}," \
...
# gtcnp(par_type="charge", center_names=["N"], cooperators=[],
