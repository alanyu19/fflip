#!/usr/bin/env python
#SBATCH --output=./.slog/senc_%A_%a.out
#SBATCH --error=./.slog/senc_%A_%a.err
#SBATCH --array=0-49
#SBATCH --cpus-per-task=1
#SBATCH --time=03:00:00
#SBATCH --partition=ivy,sbr,hwell,k20,k40
#SBATCH --ntasks=1
#SBATCH --mem=1G
...
def main(property_indexes, first_trj, last_trj, perturbation, iter):
    ...
    for count, i in enumerate(indexes):
        if int(slurm_id) == int(i):
            ...
            properties[i].get_sensitivity(iter, force_redo=True)
