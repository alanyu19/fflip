...
class objective_function_1(object):
    ...
    def __call__(self):
        ...
        if self.objfunc_counter==1: 
            ...
            os.system("rm -r olds")
            os.chdir(self.driver_path + "c7_fitting")
            os.system("rm -r olds")
        ...
        replace(self.driver_path + "toppar/c36ua.str", 1588, substringch_1)
        replace(self.driver_path + "toppar/c36ua.str", 1589, substringch_2)
        replace(self.driver_path + "toppar/c36ua.str", 1590, substringch_3)
...
class objective_function_3(object):
...
class objective_function_4(object):
    # To be finished
    def __init__(self, targets, driver_path, objfunc_counter, x):
        self.targets = targets
        self.objfunc_counter = objfunc_counter
