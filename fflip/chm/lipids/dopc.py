...
dopc_gs.append(charmm_group(num_atom_category=5, # NTL, HL, CTL5, CTL2, HL
                           atoms=[['N'],
                           ...
                           half_r_mins=[1.85, 0.7, 2.010, 2.06, 0.7], 
                           ...
                           atoms_same_lj=[[],['H12A','H12B'],[],['C11','C1','C22','C3','C32'],[]]
                          )
             )

dopc_gs.append(charmm_group(num_atom_category=7, # CTL2, HAL2, PL, 02L, OSLP, CTL2, HAL2
                           atoms=[['C11'],
                                  ['H11A','H11B'],
                                  ['P'],
                                  ['O13','O14'],
...
dopc_gs.append(charmm_group(num_atom_category=7, # CTL1, HAL1, OSL, CL, OBL, CTL2, HAL2
...
dopc_gs.append(charmm_group(num_atom_category=7, # CTL2, HAL2, OSL, CL, OBL, CTL2, HAL2
