...
dmpc_gs.append(charmm_group(num_atom_category=5, # NTL, HL, CTL5, CTL2, HL
                           atoms=[['N'],
...
dmpc_gs.append(charmm_group(num_atom_category=7, # CTL2, HAL2, PL, 02L, OSLP, CTL2, HAL2
                           atoms=[['C11'],
                                  ['H11A','H11B'],
                                  ['P'],
                                  ['O13','O14'],
...
dmpc_gs.append(charmm_group(num_atom_category=7, # CTL1, HAL1, OSL, CL, OBL, CTL2, HAL2
...
dmpc_gs.append(charmm_group(num_atom_category=7, # CTL2, HAL2, OSL, CL, OBL, CTL2, HAL2
