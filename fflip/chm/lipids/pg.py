...
pg_gs.append(
    CharmmGroup(
        ...
        add_charge_nbgroup=[True, True, True, True, False, True, True, True],
        atoms_same_charge=None,
        neighbors=[[4], [0], [0], [2], [], [4], [4], [6]],
        cooperators=None,
        add_lj_nbgroup=[False, False, True, True, False, False, False, False],
...
pg = Lipid(charmm_group_list=pg_gs, name="PG")
